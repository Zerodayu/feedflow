...
const modalStyle = StyleSheet.create({
  ...
  scheduleCardCompleted: {
    ...
    backgroundColor: mainColors.primary + '10',
  },
  scheduleCardContent: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  scheduleIconContainer: {
    ...
    height: 40,
    borderRadius: 20,
    backgroundColor: mainColors.accent + "20",
    alignItems: 'center',
    justifyContent: 'center',
    marginRight: 12,
  },
  scheduleIconContainerCompleted: {
    backgroundColor: mainColors.primary + '30',
  },
  scheduleDetails: {
    flex: 1,
  },
  ...
  scheduleHint: {
    fontSize: 14,
    fontWeight: "400",
    color: mainColors.foreground + "70",
    marginTop: 4,
  },
  scheduleCardActions: {
    flexDirection: 'row',
  ...
  scheduleDeleteButton: {
    padding: 8,
    borderRadius: 8,
    backgroundColor: mainColors.destructive + "10",
  },
  scheduleDeleteButtonCompleted: {
    backgroundColor: mainColors.primary + '20',
  },
  emptyScheduleCard: {
    flex: 1,
